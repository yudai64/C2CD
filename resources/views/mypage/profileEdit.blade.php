                ...
                <div class="card-body">
                    <form method="POST" action="/mypage/profile/update">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="postal_code" type="text" class="form-control @error('postal_code') is-invalid @enderror" name="postal_code" value="{{ $profile->postal_code }}" required autocomplete="postal_code" placeholder="150-0022">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone_number" type="text" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ $profile->phone_number }}" required autocomplete="phone_number"  placeholder="03-6721-7105">
